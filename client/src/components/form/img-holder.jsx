        ...
        <div className="d-flex h-100">
            {
                images.length === 1 ? (
                    <div className="w-100 h-100 position-relative">
                        ...
                        <img src={images[0]} alt="uploaded" className="object-fit-cover w-100 h-100 rounded-10 max-height-400" />
                    ...
                    <>
                        ...
                        <div className="w-50 pl-1 position-relative">
                            ...
                            <img src={images[1]} alt="uploaded" className="object-fit-cover w-100 h-100 rounded-10 max-height-400" />
                            {showActionButtons && editButton("6px", "10px")}
                        </div>
                    </>
                ) : images.length === 3 ? (
                    <>
                        ...
                        <div className="w-50 pl-1 d-flex flex-column">
                            <div className="h-50 pb-1 position-relative">
                                ...
                                <img src={images[1]} alt="uploaded" className="object-fit-cover w-100 h-100 rounded-10 max-height-200" />
                            ...
                            <div className="h-50 pt-1 position-relative">
                                ...
                                <img src={images[2]} alt="uploaded" className="object-fit-cover w-100 h-100 rounded-10 max-height-200" />
                    ...
                    <div className="d-flex flex-column">
                        <div className="d-flex pb-1 h-50">
                            <div className="w-50 pr-1 position-relative">
                                {showActionButtons && removeImageIcon(0, "10px")}
                                <img src={images[0]} alt="uploaded" className="object-fit-cover w-100 h-100 rounded-10 max-height-200" />
                                {showActionButtons && editButton("6px", "10px")}
                            </div>
                        ...
                        <div className="d-flex pt-1 h-50">
                            ...
                            <div className="w-50 pl-1 position-relative">
                                ...
                                <img src={images[3]} alt="uploaded" className="object-fit-cover w-100 h-100 rounded-10 max-height-200" />
                                {showActionButtons && editButton("6px", "10px")}
                            </div>
                        </div>
                    </div>
